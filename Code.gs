...
function createFromExisting(sheet_name, range_person_name, range_timeslot, range_timestamp,
  ...
  var newConfig = getDefaultConfig(sheet_name);
  newConfig.range_person_name = range_person_name;
  newConfig.range_timeslot = range_timeslot;
  newConfig.range_timestamp = range_timestamp;

  newConfig.lookup_sheet_name = lookup_sheet_name;
  newConfig.lookup_range_person_name = lookup_range_person_name;
  newConfig.lookup_range_timeslot = lookup_range_timeslot;
  newConfig.lookup_range_timestamp = lookup_range_timestamp;
  newConfig.lookup_data_retention_days = lookup_data_retention_days;
